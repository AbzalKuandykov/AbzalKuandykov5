...
var big = document.querySelector("bigImage img")
function img2(){  
    document.getElementById("i2").innerHTML = document.querySelector("bigImage img");
    big.src=image2.src;
...
var big = document.querySelector("bigImage img")
function img3(){  
    document.getElementById("i3").innerHTML = document.querySelector("bigImage img");
    big.src=image3.src;
...
var big = document.querySelector("bigImage img")
function img4(){  
    document.getElementById("i4").innerHTML = document.querySelector("bigImage img");
    big.src=image4.src;
